...
void RunExploit()
{
	...
	//These two functions will set the DACL on an arbitrary file (see hardlink in main), change the security descriptor string parameters if needed addeding 1234 stufff  aweq4e23434234234234234234234234234.	
...
int mainf()
{
	...
	HMODULE mod = GetModuleHandle(L"Mead-LPE");
